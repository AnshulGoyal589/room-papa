...
export default function WeekendDeals() {
  ...
  return (
    <div className="bg-gradient-to-r from-[#001d2c] to-indigo-50 py-16 px-4">
      <div className="container mx-auto">
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <span className="text-xl font-bold text-[#001d2c] ml-2">{deal.discountedPrice}</span>
                  </div>
                  <button className="bg-[#001d2c] text-white px-4 py-2 rounded hover:bg-[#001d2c] transition">
                    Book Now
                  </button>
                </div>
              </div>
        ...
        <div className="mt-8 text-center">
          <button className="border-2 border-[#001d2c] text-[#001d2c] px-6 py-3 rounded-lg hover:bg-[#001d2c] hover:text-white transition duration-300">
