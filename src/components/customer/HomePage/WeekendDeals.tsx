...
export default function WeekendDeals() {
  ...
  return (
    <div className="bg-gradient-to-r from-[#003c95] to-indigo-50 py-16 px-4">
      <div className="container mx-auto">
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <span className="text-xl font-bold text-[#003c95] ml-2">{deal.discountedPrice}</span>
                  </div>
                  <button className="bg-[#003c95] text-white px-4 py-2 rounded hover:bg-[#003c95] transition">
                    Book Now
                  </button>
                </div>
              </div>
        ...
        <div className="mt-8 text-center">
          <button className="border-2 border-[#003c95] text-[#003c95] px-6 py-3 rounded-lg hover:bg-[#003c95] hover:text-white transition duration-300">
