        ...
        <div className="w-full sm:w-2/3 md:flex-grow p-3 sm:p-4 flex flex-col">
            <div className="flex flex-col sm:flex-row justify-between sm:items-start mb-1">
                <Link href={`/customer/trip/${trip._id}`} className="block">
                  <h3 className="text-lg sm:text-xl font-bold text-blue-700 hover:text-blue-800 transition-colors line-clamp-2">{trip.title || "Adventure Awaits"}</h3>
                </Link>
          ...
          <div className="mt-auto pt-1 sm:pt-2 text-center sm:text-right">
            ...
            <Link 
              ...
              className="mt-2 inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-3 sm:px-5 rounded-md text-xs sm:text-sm transition-colors w-full sm:w-auto"
            >
              View Details
            </Link>
          </div>
